...
const DeleteUI string = "DELETE LINES IN RANGE (inclusive): low/high [malformed input will be ignored]: "
const CopyUI string = "STORE LINES IN RANGE (inclusive): low/high [malformed input will be ignored]: "
