...
const helpMessage string = "\n\r" +
	...
	"> valid types are: 'keyword', 'bracket', 'strings', 'comment' & 'mlincom' (for multi-line code comments)\n\r" +
	"> the different types dictate how the syntax highlighting is applied\n\r" +
	"> note - there are only 6 valid bracket identifiers: '(', ')', '[', ']', '{', '}'\n\r" +
	"> note - identifiers for string entries must be single-char\n\r" +
	...
	"> note -  if low > high, the input will be ignored\n\r" +
